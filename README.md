...
- Node.js (желательно актуальный LTS)
- Включённый Corepack (чтобы использовать закреплённую версию пакетного менеджера)
- Пакетный менеджер: **pnpm** (обязателен)

### Включить pnpm через Corepack (один раз на машине)
